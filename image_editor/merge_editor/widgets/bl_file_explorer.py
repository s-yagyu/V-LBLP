...
class BLFileExplorer(FileExplorer):
    def __init__(self, parent, editor):
        super().__init__(parent, editor, "bottom-left",False)
        # デフォルト表示色の設定
        self.folder.color = {"r": 0, "g": 255, "b": 0, "a": 255}

    def create_widgets(self):
        super().create_widgets()
        self.ImgLabel.setText("C Images Folder")

    def on_open_button_clicked(self):
        self.editor.open_folder(
            self.folder_key, dialog_message="Open Images Folder C")
