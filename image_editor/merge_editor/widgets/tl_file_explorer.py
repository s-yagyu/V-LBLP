...
class TLFileExplorer(FileExplorer):
    def __init__(self, parent, editor):
        super().__init__(parent, editor, "top-left", False)
        # デフォルト表示色の設定
        self.folder.color = {"r": 0, "g": 0, "b": 255, "a": 255}

    def create_widgets(self):
        super().create_widgets()
        self.ImgLabel.setText("A Images Folder")

    def on_open_button_clicked(self):
        self.editor.open_folder(
            self.folder_key, dialog_message="Open Images Folder A")
